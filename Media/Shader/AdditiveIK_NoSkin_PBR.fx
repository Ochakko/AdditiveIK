...
SPSInShadowReciever VSMainNoSkinPBRShadowReciever(SVSInWithoutBone vsIn, uniform bool hasSkin)
{
...
/// </summary>
SPSOut2 PSMainNoSkinPBR(SPSIn psIn) : SV_Target
{
...
SPSOut0 PSMainNoSkinPBRShadowMap(SPSInShadowMap psIn) : SV_Target0
{
    float4 albedoColor = g_albedo.Sample(g_sampler_albedo, psIn.uv); // * diffusecol;
...
SPSOut2 PSMainNoSkinPBRShadowReciever(SPSInShadowReciever psIn) : SV_Target
{
    //float4 diffusecol = CalcDiffuseColor(psIn.normal, toonlightdir);
...
/////////
    ...
    //    float2 shadowValue = g_shadowMap.Sample(g_sampler, shadowMapUV).xy;        
        ...
        //    finalColor.xyz = float3(1.0f, 1.0f, 1.0f);
